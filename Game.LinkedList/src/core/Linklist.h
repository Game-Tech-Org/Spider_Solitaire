...
public:
    ...
    void removeRange(int start, int end) {
        ...
        Node<T>* beforeStart = startNode->prev;
        Node<T>* afterEnd = endNode->next;
    ...
    T getFront() const { return isEmpty() ? T() : head->data; }
    T getTail() const { return isEmpty() ? T() : tail->data; }
    
    ~LinkedList() { while (!isEmpty()) deleteFromBeginning(); }
};